...
spchdatadir = fullfile('databases','filip','data','spchdatadir');
automatic_dir = fullfile('databases','filip','data','automatic_dir'); % automatic frame output
oracleaction_dir = fullfile('databases','filip','data','oracleaction_dir'); % oracle action frames - strictly a subset of the automatic annotation that corresponds to what was said
oraclecommand_dir = fullfile('databases','filip','data','oraclecommand_dir'); % oracle command frames - a frame description of what was said that accounts for ambiguity in the spoken command (e.g. "red" which can mean both harts and diamonds). Usefull for error measuring
transcriptiondir = fullfile('databases','filip','data','transcriptiondir');
